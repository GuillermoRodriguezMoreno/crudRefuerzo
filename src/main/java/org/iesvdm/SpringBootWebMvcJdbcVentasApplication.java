...
public class SpringBootWebMvcJdbcVentasApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Cliente clienteNew = new Cliente(0, "Jose M", "Martín", null, "Málaga", 100, "ejemplo@ejemplo.es");
		...
		if (comercial.isPresent()) {
			...
			String nombreOldComercial = comercial.get().getNombre();
			...
			//Volvemos a cargar el nombre antiguo..
			comercial.get().setNombre(nombreOldComercial);
			comercialDAO.update(comercial.get());

		}

		// Como es un comercial nuevo a persistir, id a 0
		Comercial comercialNew = new Comercial(0, "Jose M", "Martín", null, new BigDecimal("0.15"));
